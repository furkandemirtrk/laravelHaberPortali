                ...
                <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
                    <div class="menu_section">
                        ...
                        <ul class="nav side-menu">
                            <li><a href="/admin/settings"><i class="fa fa-cog"></i> Ayarlar </a></li>
                            <li><a><i class="fa fa-edit"></i> Yazılar <span class="fa fa-chevron-down"></span></a>
                                <ul class="nav child_menu">
                                    <li><a href="/admin/articles">Yazılar</a></li>
                                    <li><a href="/admin/articles/add">Yazı Ekle</a></li>
                                    <li><a href="/admin/articles/category">Kategoriler</a></li>
                                    <li><a href="/admin/articles/category/add">Kategori Ekle</a></li>
                                </ul>
                            </li>
